...
export async function signIn(formData: { email: string; password: string }) {
  ...
  try {
    ...
    if (sessionError) {
      ...
      return {
        error:
          "Authentication successful but failed to create session. Please confirm your email address.",
      };
    }
...
export async function addQuote(quoteData: {
  ...
  try {
    ...
    throw new Error(
      "Failed to add quote. Please check your database connection."
    );
  }
}
...
export async function updateQuote(quoteData: {
  ...
  try {
    ...
    throw new Error(
      "Failed to update quote. Please check your database connection."
    );
  }
}
...
export async function deleteQuote(id: string) {
  try {
    ...
    throw new Error(
      "Failed to delete quote. Please check your database connection."
    );
  }
}
...
export async function addCategory(name: string) {
  try {
    ...
    throw new Error(
      "Failed to add category. Please check your database connection."
    );
  }
}
