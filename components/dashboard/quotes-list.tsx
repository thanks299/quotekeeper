  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row justify-between gap-4 mb-6">
        <div className="flex flex-wrap gap-2 category-filters">
          <Button
        ...
        <div className="relative w-full sm:w-64 search-quotes">
      ...
      <div className="fixed bottom-6 right-6 z-10 add-quote-button">
        <Button
